                  ...
                  link: function (scope, element, attrs) {
                      ...
                      function renderLikeButton() {
                          if (!!attrs.fbLike && !scope.fbLike && !watchAdded) {
                              ...
                              element.html('<div class="fb-share-button"' + (!!scope.fbLike ? ' data-href="' + scope.fbLike + '"' : '') + ' data-layout="button" data-action="like" data-show-faces="true" data-share="true"></div>');
